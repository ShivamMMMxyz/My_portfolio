...
//   return (
//     <div className="about-wrapper" style={{ display: "flex", gap: "20px" }}>
//       {/* Left floating balls */}
//       <div className="balls-column">
//         {leftIcons.map((icon, index) => (
//           <div key={index} className="ball-wrapper">
...
//             <span>JavaScript, C, C++, Python, SQL</span>
//           </div>
//           <div className="skill-group">
//             <strong>Web:</strong>
//             <span>HTML, CSS, React.js,Gsap,Framer Motion, Node.js, Express.js, MongoDB</span>
//           </div>
//           <div className="skill-group">
...
//           <div className="skill-group">
//             <strong>Other:</strong>
//             <span> MySQL, Git, REST APIs,Email js</span>
//           </div>
//           <div className="skill-group">
//             <strong>Data Structures:</strong>
//             <span>Linked Lists, Stacks, OOPs</span>
//           </div>
//           <div className="skill-group">
//             <strong>Tools:</strong>
//             <span>VS Code, GitHub, Postman, Android Studio, MongoDb Compass</span>
//           </div>
//         </section>
